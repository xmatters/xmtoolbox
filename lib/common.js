 ...
 * @param {Object} options request promose options.
 ...
 * @param {string} uri The uri to requequest without the offset query parameter.
 ...
 * @param {string} api The api endpoint past the base Utrl. Example: '/api/xm/1/groups'
 ...
 * @param {string} label The Label to define what type of obejct or objects are being acted on with this reuqest. Primarly used for logging.
 ...
 * @param {Object} query A json object representing the query string parameters for this request.
 * @param {string} label The Label to define what type of obejct or objects are being acted on with this reuqest. Primarly used for logging.
 * @returns {Object[]} Objects from all body.data arrays concatinated to a single array.
 */
 ...
 * @param {Object} options The node request optins for this request.
 * @param {string} label The Label to define what type of obejct or objects are being acted on with this reuqest. Primarly used for logging.
 * @returns {Object} Body from from create request response
 */
 ...
 * @param {number} ms The number of miliseconds to sleep.
 */
function sleep(ms) {
...
/**
 * Options to set when syncronizing data into xMatters.
 ...
 * Default: false
 * @property {boolean} delayRemoval Used only with mirror is true. Whether or not to delete the objects immediatly or return an array of objects to be removed later.<br><br>
 * Default: true
 ...
 * If undefined uses all deefined allows fields for syncronization.
 */

/**
 * An common object to return the results of syncronizing many objects of a single object type.
...
/**
 * Synchronizes an array of objects into xMatters using the available functions. It looks for a match based on the syncField. It then performs object comparason based on the fields list. If source matches it is skiped. If it does not match it updates using the update function or or not available performs a delete and create. If options.mirror is true the object is deleted if a match is not found in the source. If delayedRemoval is true these object are note removed and returned instead for later removal.
 * @param {string} name The
 * @param {Object[]} sourceObjects An array of xMatters Objects to syncronize. These are considerd to be all the the objects from the source.
 * @param {Object[]} destinationObjects An array of xMatters Objects to syncronize. These are considerd to be the objects from the destination.
