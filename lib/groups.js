...
async function get(env, groupId, query) {
  return common.get(env, '/api/xm/1/groups/', groupId, query, 'Group');
}
 ...
 * @param {module:environments.xMattersEnvironment} destination The xmtoolbox representation of the target or destination xMatters instance.Groups
 * @param {Object} options
