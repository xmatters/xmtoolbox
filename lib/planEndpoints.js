...
/**
 * A module related to xMatters communication plan endpoints.<br><br>
 * {@link https://help.xmatters.com/xmapi/index.html#plan-endpoints}
 *
 * @module planEndpoints
 */

/**@typedef module:planEndpoints.Endpoint
 * @type {Object}
 */
...
async function get(env, endpointId, query, planId) {
  return common.get(
    env,
    `/api/xm/1/plans/${encodeURIComponent(planId)}/endpoints/`,
    endpointId,
    query,
    'Plan Endpoint'
  );
 ...
 * @param {Object} query A json object representing the query string parameters for this request.
 * @param {string} planId The unique identifier (id) or name of the plan you want to list the constants for.
 * @returns {Promise<module:planEndpoints.Endpoint[]>} Array of Plan Endpoint Objects Requested
 */
 ...
 *
 * @param {module:environments.xMattersEnvironment} env The xmtoolbox representation of an xMatters instance.
 * @param {module:planEndpoints.Endpoint} endpoint {@link https://help.xmatters.com/xmapi/index.html#endpoint-object}
 * @param {string} planId The unique identifier (id) or name of the plan that will contain the endpoint.
 * @returns {Promise<module:planEndpoints.Endpoint>} Plan Endpoint Object Created
 */
 ...
 * @param {module:environments.xMattersEnvironment} env The xmtoolbox representation of an xMatters instance.
 * @param {module:planEndpoints.Endpoint} endpoint {@link https://help.xmatters.com/xmapi/index.html#endpoint-object}
 * @param {string} endpointId The unique identifier (id) of the endpoint.<br><br>
 * Examples:<br>
 ...
 * @returns {Promise<module:planEndpoints.Endpoint>} Plan Endpoint Object Updated
 */
 ...
 * @param {module:planEndpoints.Endpoint} planEndpoints Array of plan endpoint objects to transform.
...
async function exportToImport(destination, planEndpoints, destinationData) {
  ...
  return common.convertDefaultInitial(await planEndpoints, convert);

  function convert(planEndpoint) {
    {
      //set plan
 ...
 * @param {module:environments.xMattersEnvironment} destination The xmtoolbox representation of the target or destination xMatters instance.
 * @param {module:planEndpoints.Endpoint[]} sourcePlanEndpoints An array of the plan endpoint objects to synchronize from the source data.
 * @param {module:planEndpoints.Endpoint[]} destinationPlanEndpoints An array of the plan endpoint objects to synchronize from the destination data.
