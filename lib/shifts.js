...
async function get(env, shiftId, query, groupId) {
  return util.get(env, `/api/xm/1/groups/${groupId}/shifts/`, shiftId, query, `Shift`);
}
 ...
 * @param {query}
 *
 * example: {embed:'members,rotation'}
 *
 * embed: string Example: 'members,rotation'
 *
 ...
 *
 *      - rotation: Get shift rotation informa
 *
...
async function getMany(env, query, groupId) {
  return util.getMany(env, `/api/xm/1/groups/${encodeURI(groupId)}/shifts`, query, 'Shifts');
}
...
async function getMembers(env, query, shiftId, groupId) {
  return util.getMany(env, `/api/xm/1/groups/${groupId}/shifts/${shiftId}/members`, query, 'Shift Members');
}
...
async function create(env, shift, groupId) {
  return util.create(env, `/api/xm/1/groups/${groupId}/shifts/`, shift, 'Shift', true);
}
...
async function update(env, shift, shiftId, groupId) {
  return util.update(env, `/api/xm/1/groups/${groupId}/shifts/`, shift, shiftId, 'Shift');
}
...
async function _delete(env, shiftId, groupId) {
  await util.delete(env, `/api/xm/1/groups/${groupId}/shifts/`, shiftId, 'Shift');
}
 ...
 * @param {Array[shifts]} sourceGroups
 * @param {Array[shifts]} destinationGroups
 ...
 * @param {*} destination
 * @param {*} sourceShifts
 * @param {*} destinationShifts
 * @param {*} options
 * @param {*} groupId
 */
async function sync(destination, sourceShifts, destinationShifts, options, groupId) {
