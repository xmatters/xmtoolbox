...
async function get(env, shiftId, query, groupId) {
  return common.get(env, `/api/xm/1/groups/${encodeURIComponent(groupId)}/shifts/`, shiftId, query, `Shift`);
}
...
async function getMany(env, query, groupId) {
  return common.getMany(env, `/api/xm/1/groups/${encodeURIComponent(groupId)}/shifts`, query, 'Shifts');
}
...
async function getMembers(env, query, shiftId, groupId) {
  return common.getMany(
    env,
    `/api/xm/1/groups/${encodeURIComponent(groupId)}/shifts/${shiftId}/members`,
    query,
    'Shift Members'
  );
}
...
async function create(env, shift, groupId) {
  return common.create(env, `/api/xm/1/groups/${encodeURIComponent(groupId)}/shifts/`, shift, 'Shift', true);
}
...
async function update(env, shift, shiftId, groupId) {
  return common.update(
    env,
    `/api/xm/1/groups/${encodeURIComponent(groupId)}/shifts/`,
    shift,
    shiftId,
    'Shift'
  );
...
async function _delete(env, shiftId, groupId) {
  await common.delete(env, `/api/xm/1/groups/${encodeURIComponent(groupId)}/shifts/`, shiftId, 'Shift');
}
