...
async function get(env, siteId, query) {
  return common.get(env, '/api/xm/1/sites/', siteId, query, 'Site');
}
 ...
 * @param {*} sourceSites
 * @param {module:environments.xMattersEnvironment} destination The xmtoolbox representation of the target or destination xMatters instance.Sites
 * @param {*} options
 */
