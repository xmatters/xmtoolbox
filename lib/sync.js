...
async function xMattersToxMatters(sourceEnv, destinationEnv, syncOptions = {}) {
  const { mirror, dataExtracted } = xm.util.defaultsDeep(syncOptions, DefaultSyncOptions());
...
async function DataToxMatters(sourceData, destinationEnv, syncOptions = {}) {
  ...
  const { mirror } = xm.util.defaultsDeep(syncOptions, DefaultSyncOptions());
...
function GetExtractOptions(syncOptions, isDestination) {
  const {
    ...
    subscriptions,
    subscriptionForms,
  } = xm.util.defaultsDeep(syncOptions, DefaultSyncOptions());
...
async function ConvertAndSyncObjects(sourceData, destinationData, env, syncOptions) {
  ...
  const _sitesOptions = xm.util.defaultsDeep(sitesOptions, { mirror, delayRemoval, continueOnError });
  const _peopleOptions = xm.util.defaultsDeep(peopleOptions, { mirror, delayRemoval, continueOnError });
  const _devicesOptions = xm.util.defaultsDeep(devicesOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
  const _groupMembersOptions = xm.util.defaultsDeep(groupMembersOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
  const _groupsOptions = xm.util.defaultsDeep(groupsOptions, {
    mirror,
    delayRemoval,
    defaultSupervisorId,
  ...
  const _shiftsOptions = xm.util.defaultsDeep(shiftsOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
  const _dynamicTeamsOptions = xm.util.defaultsDeep(dynamicTeamsOptions, {
    mirror,
    delayRemoval,
    defaultSupervisorId,
    continueOnError,
  });
  const _temporaryAbsencesOptions = xm.util.defaultsDeep(temporaryAbsencesOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
  const _integrationsOptions = xm.util.defaultsDeep(integrationsOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
  const _plansOptions = xm.util.defaultsDeep(plansOptions, { mirror, delayRemoval: false, continueOnError });
  const _planConstantsOptions = xm.util.defaultsDeep(planConstantsOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
  const _planEndpointsOptions = xm.util.defaultsDeep(planEndpointsOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
  const _planPropertiesOptions = xm.util.defaultsDeep(planPropertiesOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
  const _sharedLibrariesOptions = xm.util.defaultsDeep(sharedLibrariesOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
  const _scenariosOptions = xm.util.defaultsDeep(scenariosOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
  const _subscriptionsOptions = xm.util.defaultsDeep(subscriptionsOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });

  const _subscriptionFormsOptions = xm.util.defaultsDeep(subscriptionFormsOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
