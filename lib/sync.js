...
async function xMattersToxMatters(sourceEnv, destinationEnv, syncOptions = {}) {
  const { mirror, dataExtracted } = util.defaultsDeep(syncOptions, DefaultSyncOptions());
...
async function DataToxMatters(sourceData, destinationEnv, syncOptions = {}) {
  ...
  const { mirror } = util.defaultsDeep(syncOptions, DefaultSyncOptions());
...
function GetExtractOptions(syncOptions, isDestination) {
  const {
    ...
    sharedLibraries,
    subscriptions,
  } = util.defaultsDeep(syncOptions, DefaultSyncOptions());
...
async function ConvertAndSyncObjects(sourceData, destinationData, env, syncOptions) {
  ...
  const _sitesOptions = util.defaultsDeep(sitesOptions, { mirror, delayRemoval, continueOnError });
  const _peopleOptions = util.defaultsDeep(peopleOptions, { mirror, delayRemoval, continueOnError });
  const _devicesOptions = util.defaultsDeep(devicesOptions, { mirror, delayRemoval: false, continueOnError });
  const _groupMembersOptions = util.defaultsDeep(groupMembersOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
  const _groupsOptions = util.defaultsDeep(groupsOptions, {
    mirror,
    delayRemoval,
    defaultSupervisorId,
  ...
  const _shiftsOptions = util.defaultsDeep(shiftsOptions, { mirror, delayRemoval: false, continueOnError });
  const _dynamicTeamsOptions = util.defaultsDeep(dynamicTeamsOptions, {
    mirror,
    delayRemoval,
    defaultSupervisorId,
    continueOnError,
  });
  const _temporaryAbsencesOptions = util.defaultsDeep(temporaryAbsencesOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
  const _integrationsOptions = util.defaultsDeep(integrationsOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
  const _plansOptions = util.defaultsDeep(plansOptions, { mirror, delayRemoval: false, continueOnError });
  const _planConstantsOptions = util.defaultsDeep(planConstantsOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
  const _planEndpointsOptions = util.defaultsDeep(planEndpointsOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
  const _planPropertiesOptions = util.defaultsDeep(planPropertiesOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
  const _sharedLibrariesOptions = util.defaultsDeep(sharedLibrariesOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
  const _scenariosOptions = util.defaultsDeep(scenariosOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
  const _subscriptionsOptions = util.defaultsDeep(subscriptionsOptions, {
    mirror,
    delayRemoval: false,
    continueOnError,
  });
